...
Ensure you have *no error messages*. This package will allow us to use rethomics Github repository as source, simplifying the installation.
...
In the same way, you could install other packages from rethomics by changing `behavr` for another package. 
