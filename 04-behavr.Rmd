...
The `behavr` package has a set of functions to make toy data. This provides us with a playgound to test functions and plots without having to get some real data.
