...
![TODO add aome figure]("rethomics_files/figure-html/achitecture-1.png")
...
pairwise.wilcox.test(summary_dt[sex=="F", sleep_fraction_all], 
                     summary_dt[sex=="F",interaction(genotype)])
```
...
Data analysis and visualisation is about **translating your biological questions in another language**.
Problems in emerging areas of science can be very rich so they should be matched with the equaly rich grammar that only a programming language can provide.
