...
**Only if we share a common data structure  can we  build a commmon set of tools**
...
Although are many similarities between subsequent analysis and visualisation tools,
...
* `ggetho` -- based on `ggplot2`, to produce high quality visualisation of  behavioural data
